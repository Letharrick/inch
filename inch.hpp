...
namespace inch {
    ...
    std::string input(std::string message, Checks... checks) {
        ...
        */
        ...
        switch (style) {
        case Style::Basic:
            input_function = std::bind(input_functions::basic_input, std::nullopt);
            break;
        case Style::Masked:
        ...
        return __utils::validate(input_function, checks...);
    }

    template <Style style = Style::Basic, bool prompt_once = false, class... Checks>
    std::string get(std::string message, Checks... checks) {
        /*
        The input function for retrieving information from the user in a computer-like manner.
    ...
    std::string ask(std::string question, Checks... checks) {
        /*
        The input function for retrieving information from the user in a human-like manner.
    ...
    namespace checks {
        ...
        Check regex(std::regex regular_expression) {
            /*
        ...
        Check numeric() {
            ...
            */
            ...
            return regex(std::regex(expression));
        }
